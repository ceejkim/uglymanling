...
## Mission
Implement the user-facing product in code with high-quality flows, states, responsiveness, and accessibility.
...
## Primary Goals
1. Build the assessment-to-plan-to-action flow cleanly.
2. Maintain strong fidelity to the Ugly Manling UI direction.
3. Ensure downstream offering modules feel connected, not fragmented.
...
## Working Rules
1. Build flows around real user decisions.
2. Keep user context visible across the journey.
...
## Success Standard
The frontend should make the platform feel coherent, fast, clear, and confident from first touch to conversion.
